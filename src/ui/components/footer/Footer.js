      ...
      <div>
        <section className="footer-msg">
          <blockquote className="quote-externo container">
            <p>
              &quot;o verdadeiro segredo da felicidade está em teer um genuíno
        ...
        <footer>
          <div className="footer">
            <Container>
              ...
              <h3>Redes Sociais</h3>
              <ul>
                  <li><a href='https://facebook.com' target='_black'><img src={imgFacebook} alt='Facebook'/></a></li>
                  <li><a href='https://instagram.com' target='_black'><img src={imgInstagram} alt='Instagram'/></a></li>
                  <li><a href='https://twitter.com' target='_black'><img src={imgTwitter} alt='Twitter'/></a></li>
              </ul>
              </div>
            </Container>
          </div>
